$(function () {
    ...
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '订单号', name: 'orderSn', index: 'order_sn', width: 140, 'align':'center'},
            ...
            {
                label: '订单状态', name: 'orderStatus', index: 'order_status', width: 80, 'align':'center', formatter: function (value) {
                    if (value == '0') {
                        return '待付款';
                    } else if (value == '101') {
                        return '订单已取消';
            ...
            {label: '快递公司', name: 'shippingName', index: 'shipping_name', width: 80, 'align':'center'},
            {label: '快递单号', name: 'shippingNo', index: 'shipping_No', width: 80, 'align':'center'},
            {label: '实际支付金额', name: 'actualPrice', index: 'actual_price', width: 80, 'align':'center'},
            {label: '订单总价', name: 'orderPrice', index: 'order_price', width: 60, 'align':'center'},
            {label: '商品总价', name: 'goodsPrice', index: 'goods_price', width: 60, 'align':'center'},
            {
                label: '下单时间', name: 'addTime', index: 'add_time', width: 80, 'align':'center',
                formatter: function (value) {
