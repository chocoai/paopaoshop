$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '关键字', name: 'keywords', index: 'keywords', width: 80, 'align':'center', hidden: true},
            {label: '简明介绍', name: 'goodsBrief', index: 'goods_brief', width: 80, 'align':'center', hidden: true},
            {label: '商品描述', name: 'goodsDesc', index: 'goods_desc', width: 80, 'align':'center', hidden: true},
            {
